...
public class ProductoFullCoberturaSuperDuper extends Productos implements Serializable {
	private static int tasaDeAumento = 1;
	private static int tasaDeBaja = 1;
	
	
	
	public ProductoFullCoberturaSuperDuper() {
		super();
	...
	public ProductoFullCoberturaSuperDuper(String nombre, int sellIn, int price) {
